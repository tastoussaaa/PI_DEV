...
class MedicationDemoController extends AbstractController
{
    ...
    public function mockRtbc(Request $request): JsonResponse
    {
        ...
        // Simple mocked RTBC response - in real use call vendor RTBC
        $response = [
            'formulary' => 'preferred',
            'copayEstimate' => 8.75,
    ...
    public function mockEprescribe(Request $request): Response
    {
        ...
        // Return a mocked NCPDP SCRIPT acceptance XML
